...
\tikzstyle{layer}=[rectangle, rounded corners, minimum width=22em, minimum height=2.2em, font=\bfseries]
\tikzstyle{comp}=[rectangle, rounded corners, draw, minimum width=8em, minimum height=1.8em, font=\small]

\node[layer, fill=blue!30] (l1) {L1: Ethereum --- Base settlement};
\node[layer, fill=blue!20, below=of l1] (l2) {L2: Arbitrum (USDC) / TON (USDT)};
\node[layer, fill=blue!40, below=of l2] (l3) {L3: Our SMR (3 валидатора)};

\node[comp, below=1.5em of l3] (pbft) {PBFT Consensus};
